...
import os.path
from sklearn.model_selection import KFold #crossvalidation depreciated
from sklearn.linear_model import LogisticRegression
from sklearn.metrics import f1_score as f1


def evaluate(encoder, k=10, seed=1234, evalcv=True, evaltest=False, use_feats=True, loc='/Users/sath/Documents/Tensorflow-models/skip_thoughts/data/msr-paraphrase-corpus/'):
    """
    Run experiment
...
def load_data(loc='/Users/sath/Documents/Tensorflow-models/skip_thoughts/data/msr-paraphrase-corpus/'):
    """
    Load MSRP dataset
    """
...
def eval_kfold(A, B, train, labels, shuffle=True, k=10, seed=1234, use_feats=False):
    ...
    npts = len(features)
    kf = KFold(n_splits=k, shuffle=shuffle, random_state=seed) #changed to n_splits
    scores = []
    ...
    for s in scan:
        ...
        for train, test in kf.split(features): #changes kf to kf.split(features)
